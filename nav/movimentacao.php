...
<button class="btn  btn-warning btn-sm" data-toggle="modal" data-target="#cad" > Nova Categoria
                                </button>
<!--    INICIO MODAL-->
...
<!--        <div class="col-md-4 order-md-2 mb-4">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Cadastre uma Entrada ou Saída</h4>
...
<!--                
              ...
              <div class="col-md-5 mb-3">
                ...
                <input type="date" class="form-control" id="data" placeholder="" name="data" required>
                <div class="invalid-feedback">
...
<!--            <hr class="mb-4">
            ...
            <div class="d-block my-3">
              ...
              <div class="custom-control custom-radio">
                  <input id="saida" name="tipo" type="radio" class="custom-control-input" value="saida" checked required>
...
<!--            <div class="row">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" name="btnmov" type="submit">Cadastrar</button>
          </form>
        </div>
      </div>
